...
async function showDatabaseStats() {
  ...
  try {
    ...
    console.log('🔥 Firebase Auth Users: ❌ Cannot access (credentials not configured)');
  }
  ...
  try {
    ...
    console.log('🔥 Firestore User Documents: ❌ Cannot access');
  }
  ...
  try {
    ...
    console.log('🍃 MongoDB Users: ❌ Cannot access');
  }
...
async function clearFirebaseAuth() {
  try {
    ...
    console.log('❌ Error clearing Firebase Auth:', error.message);
  }
}
...
async function clearFirestore() {
  try {
    ...
    console.log('❌ Error clearing Firestore:', error.message);
  }
}
...
async function clearMongoDB() {
  try {
    ...
    console.log('❌ Error clearing MongoDB:', error.message);
  }
}
...
async function main() {
  ...
  // Confirm action
  const confirm1 = await askQuestion('❓ Are you sure you want to clear ALL user data? (type "yes" to continue): ');
  ...
  const confirm2 = await askQuestion('❓ This action cannot be undone. Type "DELETE ALL USERS" to proceed: ');
